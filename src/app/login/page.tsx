...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate-950 px-4 py-8 sm:px-6">
      <div className="w-full max-w-md flex flex-col justify-between min-h-[540px] sm:min-h-0 sm:bg-slate-900/40 sm:border sm:border-slate-800/80 sm:rounded-3xl sm:p-8 sm:shadow-2xl sm:shadow-emerald-950/10 gap-8">
